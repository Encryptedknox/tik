...
def send_welcome(message):
    bot.reply_to(message, f"Hello, @{message.chat.username} Welcome! With our bot, you can easily generate strong and secure passwords. use /gen to generate password")
